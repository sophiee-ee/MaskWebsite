            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> <img src="img/powHearingLogo.PNG" alt="logo"> </a>
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="contact_process.php" method="post">
                        ...
                        <div class="form-group mt-3">
                            <button class="btn_3 button-contactForm" type="submit" name="send_message_btn">Send</button>
                            <!--<a href="#" class="btn_3 button-contactForm" name="send_message_btn">Send Message</a> -->
                        </div>
                    </form>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="media contact-info">
                        <span class="contact-info__
                        icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
